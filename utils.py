...
################################ datasets #######################################
def cifar10_dataloaders(batch_size=128, num_workers=2, data_dir='./dataset/cifar10'):
    ...
    test_set = Subset(CIFAR10(data_dir, train=True, transform=train_transform, download=True), list(range(45000, 50000)))
...
def cifar100_dataloaders(batch_size=128, num_workers=2, data_dir='./dataset/cifar100'):
...
def tiny_imagenet_dataloaders(batch_size=128, num_workers=2, data_dir = './dataset/tiny_imagenet/tiny-imagenet-200', permutation_seed=10):
